...
namespace Clubbing
{
    public partial class GlavnaForma : Form
    {
        ...
        private void IconButtonOrders_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new FormDogadajiUKlubovima());
        }

        private void IconButtonProducts_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color3);
            OpenChildForm(new FormRezervacije());
        }
        private void IconButtonMarketing_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color5);
            OpenChildForm(new FormObavijest());
        }
